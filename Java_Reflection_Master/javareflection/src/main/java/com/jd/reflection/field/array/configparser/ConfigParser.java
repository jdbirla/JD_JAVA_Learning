package com.jd.reflection.field.array.configparser;
...
public class ConfigParser {
    ...
    public static void main(String[] args) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, IOException {
        //data.GameConfig config = createConfigObject(data.GameConfig.class, GAME_CONFIG_PATH);
        data.UserInterfaceConfig config = createConfigObject(data.UserInterfaceConfig.class, UI_CONFIG_PATH);
